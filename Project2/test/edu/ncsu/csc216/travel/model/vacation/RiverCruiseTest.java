...
public class RiverCruiseTest {
	...
	public void testRiverCruise() {
		Tour t = null;
		try {
			t = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, 500, 50);
		} catch (IllegalArgumentException e) {
			fail();			
		}
		assertEquals("RC-name", t.getName());
		...
		// invalid  : name = null;
		try {
			t = new RiverCruise(null, LocalDate.of(2019, 11, 11) , 7, 500, 50);
			fail();
		} catch (IllegalArgumentException e) {	
		...
		// invalid  : name = empty 
		try {
			t = new RiverCruise("", LocalDate.of(2019, 11, 11), 7, 500, 50);
			fail();
		} catch (IllegalArgumentException e) {
			assertEquals(e.getMessage(), "Tour name is invalid.");
		}
		...
		// invalid : date == null
		try {
			t = new RiverCruise("name", null , 7, 500, 50);
			fail();
		} catch (IllegalArgumentException e) {	
		...
		try {
			t = new RiverCruise("name", LocalDate.of(2019, 11, 11), -1, 500, 50);
			fail();
		} catch (IllegalArgumentException e) {	
		...
		// invalid : duration is negative or 0
		try {
			t = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, -1, 50);
			fail();
		} catch (IllegalArgumentException e) {	
		...
		// invalid : duration is negative or 0
		try {
			t = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, 500, -1);
			fail();
		} catch (IllegalArgumentException e) {	
	...
	/**
	 * Test method for {@link edu.ncsu.csc216.travel.model.vacation.RiverCruise#costFor(int)}.
	 */
	@Test
	public void testCostFor() {
		 RiverCruise et = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, 500, 50);
		 assertEquals(750, Math.round(et.costFor(1)));
		 assertEquals(1000, (int)et.costFor(2));
		 assertEquals(1750, (int)et.costFor(3));
	}
	...
	public void testCompareTo() {
		RiverCruise t1 = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, 500, 50);
		
		// name alphabetically earlier
		RiverCruise t2 = new RiverCruise("a", LocalDate.of(2019, 11, 11), 7, 500, 50);
		// name alphabetically earlier
		RiverCruise t3 = new RiverCruise("z", LocalDate.of(2019, 11, 11), 7, 500, 50);
		...
		RiverCruise t4 = new RiverCruise("Name", LocalDate.of(2019, 10, 11), 7, 500, 50);
		// same name but start date later
		RiverCruise t5 = new RiverCruise("Name", LocalDate.of(2019, 12, 11), 7, 500, 50);
		
		assertEquals(1, t1.compareTo(t4));
		assertEquals(-1, t1.compareTo(t5));
		
		// same name, same start date, but duration shorter
		RiverCruise t6 = new RiverCruise("Name", LocalDate.of(2019, 11, 11), 6, 500, 50);
		// same name, same start date, but duration longer
		RiverCruise t7 = new RiverCruise("Name", LocalDate.of(2019, 11, 11), 8, 500, 50);
		
		assertEquals(1, t1.compareTo(t6));
		assertEquals(-1, t1.compareTo(t7));
		
		// same name, same start date, same duration
		RiverCruise t8 = new RiverCruise("Name", LocalDate.of(2019, 11, 11), 7, 500, 50);
	...
	public void testSetCapacity() {
		RiverCruise et = new RiverCruise("name", LocalDate.of(2019, 11, 11), 7, 500, 40);
		...
		// impossible to double the capacity.
		try {
			et.setCapacity(80);
			fail();
		} catch (CapacityException e) {
	...
	public void testSummaryInfo() {
		RiverCruise t1 = new RiverCruise("name1", LocalDate.of(2009, 9, 9), 7, 500, 50);
		try {
			t1.createReservationFor(new Client("name1", "contact1"), 10);
			t1.createReservationFor(new Client("name2", "contact2"), 20);
		} catch (Exception e) {
		...
		assertEquals("RC-name1: 09/09/09 7 days", t1.summaryInfo());
	}
	...
	public void testEqualsObject() {
		RiverCruise t1 = new RiverCruise("name1", LocalDate.of(2019, 10, 11), 7, 500, 50);
		// equal
		RiverCruise t2 = new RiverCruise("name1", LocalDate.of(2019, 10, 11), 7, 300, 40);
		// different name
		RiverCruise t3 = new RiverCruise("name3", LocalDate.of(2019, 10, 11), 7, 500, 50);
		// different start date
		RiverCruise t4 = new RiverCruise("name1", LocalDate.of(2019, 10, 12), 7, 500, 50);
		// different duration
		RiverCruise t5 = new RiverCruise("name1", LocalDate.of(2019, 10, 11), 3, 500, 50);
	...
	public void testAddOldReservation() {
		Tour t1 = new RiverCruise("name1", LocalDate.of(2019, 10, 11), 7, 500, 50);
